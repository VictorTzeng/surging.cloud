...
{
    public class PreviewResult : FileResult
    {
        private byte[] _fileContents;

        public PreviewResult(byte[] fileContents, string contentType)
        ...
        public PreviewResult(byte[] fileContents, MediaTypeHeaderValue contentType)
